...
// Package v1alpha1 contains API Schema definitions for the batchjob v1alpha1 API group
//+kubebuilder:object:generate=true
//+groupName=batchjob.gcr.io
package v1alpha1
...
var (
	...
	GroupVersion = schema.GroupVersion{Group: "batchjob.gcr.io", Version: "v1alpha1"}
